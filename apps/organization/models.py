...
class CourseOrg(models.Model):
    ...
    city = models.ForeignKey(CityDict, verbose_name='城市', null=True, on_delete=models.SET_NULL)
...
class Teacher(models.Model):
    org = models.ForeignKey(CourseOrg, verbose_name='所属机构', null=True, on_delete=models.SET_NULL)
    name = models.CharField(max_length=50, verbose_name='教师名')
    work_years = models.IntegerField(default=0, verbose_name='工作年限')
    work_company = models.CharField(max_length=50, verbose_name='就职公司')
    work_position = models.CharField(max_length=50, verbose_name='职位')
    image = models.ImageField(max_length=100, upload_to='teacher/%Y/%m',null=True, verbose_name='头像')
